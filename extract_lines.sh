...
cat osm-transit-extractor_lines.csv|xsv select 1-8 |xsv search -s mode 'ferry|bus' |xsv search -s shape '^$' -v > lines_with_shapes.csv
...
cp lines_with_shapes.csv output/lines.csv
